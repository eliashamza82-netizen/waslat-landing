...
root.innerHTML = `
  <button id="wc-bubble" aria-label="${T.title}"><img src="https://res.cloudinary.com/dit4pez6a/image/upload/v1782330357/waslat_logo_transparent_bzcyyg.png" alt="Waslat"></button>
